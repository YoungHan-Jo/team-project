...
<body>
	...
	<section id="hero" class="d-flex align-items-center text-center">
		<div class="container">
			...
			<button type="button" id="btn2" onclick="location.href='/admin/logmsUpdateMember'">회원수정</button><br>
			...
			<button type="button" id="btn4" onclick="location.href='/admin/logmsUpdateBoard'">게시글수정</button><br>
			<button type="button" id="btn5" onclick="location.href='/admin/logmsInsertNotice'">공지사항입력</button><br>
