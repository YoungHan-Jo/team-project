						...
						<div class="card shadow text-center"
							...
							<div class="panel panel-primary p-3">
								<div class="panel-heading">
									<h3 class="panel-title text-white p-3" style="background-color: #112D4E; border-radius: 0.5rem; font-weight: bold;">내가 만든 퀴즈 리스트</h3>
									<div class="pull-right">
										<label class="mt-3"><small>&laquo; 만든 퀴즈 개수: ${ pageMaker.totalCount } &raquo;</small></label>
										<span class="clickable filter" data-toggle="tooltip" title="Toggle table filter" data-container="body">
											<i class="glyphicon glyphicon-filter"></i>
										</span>
									</div>
								</div>
								<table class="table table-hover" id="myQuiz">
									<thead>
										<tr>
											<th>퀴즈 번호</th>
											<th>퀴즈 제목</th>
